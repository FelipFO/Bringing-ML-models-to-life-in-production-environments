...
class TestIntegration(TestCase):
    ...
    def test_feedback(self):
        ...
        try:
            ...
            self.assertEqual(response.status_code, 200)
            print(f"settings:{settings.FEEDBACK_FILEPATH}")
            print(f"exits:{os.path.exists(settings.FEEDBACK_FILEPATH)}")
        ...
        print(f"new_feedback_lines:{new_feedback_lines}")
        print(f"cur_feedback_lines:{curr_feedback_lines}")
